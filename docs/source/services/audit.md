...
flowchart LR
    ...
    click W "src/kentik_api/gen/audit/services/audit.py"
    click REST "src/kentik_api/gen/audit/services"
    click RJ "src/kentik_api/core/rest_runtime.py"
    click M "src/kentik_api/gen/audit/models"
    click E "src/kentik_api/gen/audit/error/__init__.py"
```

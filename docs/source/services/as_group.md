...
flowchart LR
    ...
    click W "src/kentik_api/gen/as_group/services/as_group.py"
    click REST "src/kentik_api/gen/as_group/services"
    click RJ "src/kentik_api/core/rest_runtime.py"
    click M "src/kentik_api/gen/as_group/models"
    click E "src/kentik_api/gen/as_group/error/__init__.py"
```

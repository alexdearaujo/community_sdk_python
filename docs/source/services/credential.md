...
flowchart LR
    ...
    click W "../../../src/kentik_api/gen/credential/services/credential.py"
    click REST "../../../src/kentik_api/gen/credential/services/"
    click RJ "../../../src/kentik_api/core/rest_runtime.py"
    click M "../../../src/kentik_api/gen/credential/models/"
    click E "../../../src/kentik_api/gen/credential/error/__init__.py"
```

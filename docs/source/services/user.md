...
flowchart LR
    ...
    click W "src/kentik_api/gen/user/services/user.py"
    click REST "src/kentik_api/gen/user/services"
    click RJ "src/kentik_api/core/rest_runtime.py"
    click M "src/kentik_api/gen/user/models"
    click E "src/kentik_api/gen/user/error/__init__.py"
```

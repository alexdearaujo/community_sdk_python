...
One Markdown page per Kentik API service, generated by `scripts/generation/endpoint_docs.py`. **Do not hand-edit these files** — they are overwritten on every `make generate` run.

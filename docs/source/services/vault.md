...
flowchart LR
    ...
    click W "src/kentik_api/gen/vault/services/vault.py"
    click REST "src/kentik_api/gen/vault/services"
    click RJ "src/kentik_api/core/rest_runtime.py"
    click M "src/kentik_api/gen/vault/models"
    click E "src/kentik_api/gen/vault/error/__init__.py"
```

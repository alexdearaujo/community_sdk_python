...
flowchart LR
    ...
    click W "../../../src/kentik_api/gen/enrichments/services/enrichments.py"
    click REST "../../../src/kentik_api/gen/enrichments/services/"
    click RJ "../../../src/kentik_api/core/rest_runtime.py"
    click M "../../../src/kentik_api/gen/enrichments/models/"
    click E "../../../src/kentik_api/gen/enrichments/error/__init__.py"
```

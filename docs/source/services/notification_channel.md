...
flowchart LR
    ...
    click W "src/kentik_api/gen/notification_channel/services/notification_channel.py"
    click REST "src/kentik_api/gen/notification_channel/services"
    click RJ "src/kentik_api/core/rest_runtime.py"
    click M "src/kentik_api/gen/notification_channel/models"
    click E "src/kentik_api/gen/notification_channel/error/__init__.py"
```

...
flowchart LR
    ...
    click W "src/kentik_api/gen/ktbgp/services/ktbgp.py"
    click REST "src/kentik_api/gen/ktbgp/services"
    click RJ "src/kentik_api/core/rest_runtime.py"
    click M "src/kentik_api/gen/ktbgp/models"
    click E "src/kentik_api/gen/ktbgp/error/__init__.py"
```

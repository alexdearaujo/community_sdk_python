...
from .AlertFilters import AlertFilters
...
class AlertServiceListRequest(BaseModel):
    """
    AlertServiceListRequest model
    """
    ...
    filters: Optional[AlertFilters] = Field(validation_alias="filters", default=None)

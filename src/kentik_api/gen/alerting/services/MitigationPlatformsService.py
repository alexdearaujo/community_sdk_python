...
def List(
    ...
    *,
    ...
    body = request_json(
        method="get",
        path="/v202505/mitigations/platforms",
    ...
    return (
        MitigationPlatformsServiceListResponse(**body)
        if body is not None
        else MitigationPlatformsServiceListResponse.model_construct()
    )
...
def Get(
    ...
    body = request_json(
        method="get",
        path=f"/v202505/mitigations/platforms/{id}",
        api_config_override=api_config_override,
        query_params=query_params,
        header_params=header_params,
        expected_status=200,
    ...
    return (
        MitigationPlatformsServiceGetResponse(**body)
        if body is not None
        else MitigationPlatformsServiceGetResponse.model_construct()
    )

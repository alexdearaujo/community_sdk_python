...
For the full endpoint reference (parameters, responses, usage examples) and data model documentation, see the Sphinx docs: `docs/sphinx/services/capacity_plan.md`.

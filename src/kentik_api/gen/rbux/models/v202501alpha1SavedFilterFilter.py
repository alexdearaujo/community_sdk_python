...
from .v202501alpha1FilterField import v202501alpha1FilterField
from .v202501alpha1FilterOperator import v202501alpha1FilterOperator


class v202501alpha1SavedFilterFilter(BaseModel):
    """
    v202501alpha1SavedFilterFilter model
    """

    model_config = {"populate_by_name": True, "validate_assignment": True}

    filterField: Optional[v202501alpha1FilterField] = Field(
        validation_alias="filterField", default=None
    )

    operator: Optional[v202501alpha1FilterOperator] = Field(

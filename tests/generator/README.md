...
| `test_endpoint_docs.py` | `parse_wrapper_methods()`/wrapper-signature parsing in [`scripts/generation/endpoint_docs.py`](../../scripts/generation/endpoint_docs.py) and [`_shared.py`](../../scripts/generation/_shared.py). |
...
| `test_generate_sdk.py` | [`scripts/generate_sdk.py`](../../scripts/generate_sdk.py)'s top-level helpers: schema-name cleanup, request-body `$ref` inlining, generated gRPC import rewriting, and the validate-before-clean ordering guard. |
